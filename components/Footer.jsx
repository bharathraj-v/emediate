...
const Footer = () => (
    <footer className="p-4 shadow md:flex md:items-center md:justify-between md:p-6 bg-opacity-70 bg-gray-800">
    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 E-Mediate™. Built by Bharath Raj
    </span>
